...
//@interface Arlearn2ipadObject : NSObject
//@end

@interface Arlearn2ipadObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Arlearn2ipadObject class]])
		{
			for (NSString *key in [[(Arlearn2ipadObject*)o modules] allKeys])
			{
