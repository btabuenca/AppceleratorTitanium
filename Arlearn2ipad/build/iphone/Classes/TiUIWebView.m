...
static NSString * const kArlearn2ipadJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_arlearn2ipadInjection
{
	...
	[html appendString:kArlearn2ipadJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Arlearn2ipad bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _arlearn2ipadInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to Arlearn2ipad support.",url);
				}
			}
