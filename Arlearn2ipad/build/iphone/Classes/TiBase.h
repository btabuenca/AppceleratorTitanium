...
// in simulator we redefine to format for Arlearn2ipad Developer console
...
{\
	NSString * exceptionName = [@"org.arlearn2ipad." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.arlearn2ipad";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIArlearn2ipadNativeItemNone = -1, 
	UIArlearn2ipadNativeItemSpinner = -2,
	UIArlearn2ipadNativeItemProgressBar = -3,
	
	UIArlearn2ipadNativeItemSlider = -4,
	UIArlearn2ipadNativeItemSwitch = -5,
	UIArlearn2ipadNativeItemMultiButton = -6,
	UIArlearn2ipadNativeItemSegmented = -7,
	
	UIArlearn2ipadNativeItemTextView = -8,
	UIArlearn2ipadNativeItemTextField = -9,
	UIArlearn2ipadNativeItemSearchBar = -10,
	
	UIArlearn2ipadNativeItemPicker = -11,
	UIArlearn2ipadNativeItemDatePicker = -12,
	
	UIArlearn2ipadNativeItemInfoLight = -13,
	UIArlearn2ipadNativeItemInfoDark = -14,
	
	UIArlearn2ipadNativeItemDisclosure = -15,
	
	UIArlearn2ipadNativeItemContactAdd = -16
};
