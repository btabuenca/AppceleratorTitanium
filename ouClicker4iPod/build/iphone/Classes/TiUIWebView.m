...
static NSString * const kouClicker4iPodJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_ouclicker4ipodInjection
{
	...
	[html appendString:kouClicker4iPodJavascript];
...
{
	// attempt to make well-formed HTML and inject in our ouClicker4iPod bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _ouclicker4ipodInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to ouClicker4iPod support.",url);
				}
			}
