...
//@interface ouClicker4iPodObject : NSObject
//@end

@interface ouClicker4iPodObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ouClicker4iPodObject class]])
		{
			for (NSString *key in [[(ouClicker4iPodObject*)o modules] allKeys])
			{
