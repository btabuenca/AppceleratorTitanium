...
// in simulator we redefine to format for ouClicker4iPod Developer console
...
{\
	NSString * exceptionName = [@"org.ouclicker4ipod." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ouclicker4ipod";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIouClicker4iPodNativeItemNone = -1, 
	UIouClicker4iPodNativeItemSpinner = -2,
	UIouClicker4iPodNativeItemProgressBar = -3,
	
	UIouClicker4iPodNativeItemSlider = -4,
	UIouClicker4iPodNativeItemSwitch = -5,
	UIouClicker4iPodNativeItemMultiButton = -6,
	UIouClicker4iPodNativeItemSegmented = -7,
	
	UIouClicker4iPodNativeItemTextView = -8,
	UIouClicker4iPodNativeItemTextField = -9,
	UIouClicker4iPodNativeItemSearchBar = -10,
	
	UIouClicker4iPodNativeItemPicker = -11,
	UIouClicker4iPodNativeItemDatePicker = -12,
	
	UIouClicker4iPodNativeItemInfoLight = -13,
	UIouClicker4iPodNativeItemInfoDark = -14,
	
	UIouClicker4iPodNativeItemDisclosure = -15,
	
	UIouClicker4iPodNativeItemContactAdd = -16
};
