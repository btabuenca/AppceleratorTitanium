...
// Selected option sex for evolution
app.model.session.slider = {};
app.model.session.slider.onemonth;
app.model.session.slider.sixmonths;
app.model.session.slider.oneyear;
app.model.session.slider.fiveyears;
app.model.session.slider.tenyears;
app.model.session.slider.wholelife;
app.model.session.slider.gender;
