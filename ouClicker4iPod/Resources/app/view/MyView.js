...
app.view.MyView = function() {
	...
	return {
		...
		getSaveSliderWindow: function() {
			Ti.API.debug("btabuenca. Debugging getSaveSliderWindow");
			tabGroup.activeTab.open(app.view.ui.getSaveSliderWindow(),{animated:true});
			
			//return app.view.ui.getSaveSliderWindow();
