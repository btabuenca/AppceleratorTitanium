...
// in simulator we redefine to format for ouClicker_MVC Developer console
...
{\
	NSString * exceptionName = [@"org.ouclicker_mvc." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ouclicker_mvc";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIouClicker_MVCNativeItemNone = -1, 
	UIouClicker_MVCNativeItemSpinner = -2,
	UIouClicker_MVCNativeItemProgressBar = -3,
	
	UIouClicker_MVCNativeItemSlider = -4,
	UIouClicker_MVCNativeItemSwitch = -5,
	UIouClicker_MVCNativeItemMultiButton = -6,
	UIouClicker_MVCNativeItemSegmented = -7,
	
	UIouClicker_MVCNativeItemTextView = -8,
	UIouClicker_MVCNativeItemTextField = -9,
	UIouClicker_MVCNativeItemSearchBar = -10,
	
	UIouClicker_MVCNativeItemPicker = -11,
	UIouClicker_MVCNativeItemDatePicker = -12,
	
	UIouClicker_MVCNativeItemInfoLight = -13,
	UIouClicker_MVCNativeItemInfoDark = -14,
	
	UIouClicker_MVCNativeItemDisclosure = -15,
	
	UIouClicker_MVCNativeItemContactAdd = -16
};
