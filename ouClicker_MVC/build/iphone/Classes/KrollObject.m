...
//@interface ouClicker_MVCObject : NSObject
//@end

@interface ouClicker_MVCObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ouClicker_MVCObject class]])
		{
			for (NSString *key in [[(ouClicker_MVCObject*)o modules] allKeys])
			{
