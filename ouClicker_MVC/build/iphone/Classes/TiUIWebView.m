...
static NSString * const kouClicker_MVCJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_ouclicker_mvcInjection
{
	...
	[html appendString:kouClicker_MVCJavascript];
...
{
	// attempt to make well-formed HTML and inject in our ouClicker_MVC bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _ouclicker_mvcInjection]];
	...
	else
	{
		...
		if ([[NSFileManager defaultManager] fileExistsAtPath:path])
		{
			...
			else
			{
				...
				{
					NSLog(@"[WARN] I have no idea what the appropriate text encoding is for: %@. Please report this to ouClicker_MVC support.",url);
				}
			}
