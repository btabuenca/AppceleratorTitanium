...
// in simulator we redefine to format for ARlearn2 Developer console
...
{\
	NSString * exceptionName = [@"org.arlearn2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.arlearn2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIARlearn2NativeItemNone = -1, 
	UIARlearn2NativeItemSpinner = -2,
	UIARlearn2NativeItemProgressBar = -3,
	
	UIARlearn2NativeItemSlider = -4,
	UIARlearn2NativeItemSwitch = -5,
	UIARlearn2NativeItemMultiButton = -6,
	UIARlearn2NativeItemSegmented = -7,
	
	UIARlearn2NativeItemTextView = -8,
	UIARlearn2NativeItemTextField = -9,
	UIARlearn2NativeItemSearchBar = -10,
	
	UIARlearn2NativeItemPicker = -11,
	UIARlearn2NativeItemDatePicker = -12,
	
	UIARlearn2NativeItemInfoLight = -13,
	UIARlearn2NativeItemInfoDark = -14,
	
	UIARlearn2NativeItemDisclosure = -15,
	
	UIARlearn2NativeItemContactAdd = -16
};
