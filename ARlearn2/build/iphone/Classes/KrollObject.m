...
//@interface ARlearn2Object : NSObject
//@end

@interface ARlearn2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ARlearn2Object class]])
		{
			for (NSString *key in [[(ARlearn2Object*)o modules] allKeys])
			{
