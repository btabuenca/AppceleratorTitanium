 ...
 * Copyright (c) 2009-2011 by celstecClicker, Inc. All Rights Reserved.
...
//@interface celstecClickerObject : NSObject
//@end

@interface celstecClickerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[celstecClickerObject class]])
		{
			for (NSString *key in [[(celstecClickerObject*)o modules] allKeys])
			{
