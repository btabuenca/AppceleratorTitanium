...
// in simulator we redefine to format for celstecClicker Developer console
...
{\
	NSString * exceptionName = [@"org.celstecclicker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.celstecclicker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIcelstecClickerNativeItemNone = -1, 
	UIcelstecClickerNativeItemSpinner = -2,
	UIcelstecClickerNativeItemProgressBar = -3,
	
	UIcelstecClickerNativeItemSlider = -4,
	UIcelstecClickerNativeItemSwitch = -5,
	UIcelstecClickerNativeItemMultiButton = -6,
	UIcelstecClickerNativeItemSegmented = -7,
	
	UIcelstecClickerNativeItemTextView = -8,
	UIcelstecClickerNativeItemTextField = -9,
	UIcelstecClickerNativeItemSearchBar = -10,
	
	UIcelstecClickerNativeItemPicker = -11,
	UIcelstecClickerNativeItemDatePicker = -12,
	
	UIcelstecClickerNativeItemInfoLight = -13,
	UIcelstecClickerNativeItemInfoDark = -14,
	
	UIcelstecClickerNativeItemDisclosure = -15,
	
	UIcelstecClickerNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all celstecClicker instances of
