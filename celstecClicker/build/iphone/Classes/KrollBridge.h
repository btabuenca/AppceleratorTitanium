...
@interface celstecClickerObject : KrollCoverageObject {
#else
@interface celstecClickerObject : KrollObject {
#endif
@private
...
extern NSString * celstecClicker$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	celstecClickerObject *_celstecclicker;
	BOOL shutdown;
