...
//@interface GuiaCataVinoObject : NSObject
//@end

@interface GuiaCataVinoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GuiaCataVinoObject class]])
		{
			for (NSString *key in [[(GuiaCataVinoObject*)o modules] allKeys])
			{
