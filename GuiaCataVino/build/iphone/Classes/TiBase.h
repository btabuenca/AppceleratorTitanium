...
// in simulator we redefine to format for GuiaCataVino Developer console
...
{\
	NSString * exceptionName = [@"org.guiacatavino." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.guiacatavino";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIGuiaCataVinoNativeItemNone = -1, 
	UIGuiaCataVinoNativeItemSpinner = -2,
	UIGuiaCataVinoNativeItemProgressBar = -3,
	
	UIGuiaCataVinoNativeItemSlider = -4,
	UIGuiaCataVinoNativeItemSwitch = -5,
	UIGuiaCataVinoNativeItemMultiButton = -6,
	UIGuiaCataVinoNativeItemSegmented = -7,
	
	UIGuiaCataVinoNativeItemTextView = -8,
	UIGuiaCataVinoNativeItemTextField = -9,
	UIGuiaCataVinoNativeItemSearchBar = -10,
	
	UIGuiaCataVinoNativeItemPicker = -11,
	UIGuiaCataVinoNativeItemDatePicker = -12,
	
	UIGuiaCataVinoNativeItemInfoLight = -13,
	UIGuiaCataVinoNativeItemInfoDark = -14,
	
	UIGuiaCataVinoNativeItemDisclosure = -15,
	
	UIGuiaCataVinoNativeItemContactAdd = -16
};
