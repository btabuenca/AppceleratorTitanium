...
//@interface KitchenSinkObject : NSObject
//@end

@interface KitchenSinkObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KitchenSinkObject class]])
		{
			for (NSString *key in [[(KitchenSinkObject*)o modules] allKeys])
			{
