...
// in simulator we redefine to format for KitchenSink Developer console
...
{\
	NSString * exceptionName = [@"org.kitchensink." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.kitchensink";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIKitchenSinkNativeItemNone = -1, 
	UIKitchenSinkNativeItemSpinner = -2,
	UIKitchenSinkNativeItemProgressBar = -3,
	
	UIKitchenSinkNativeItemSlider = -4,
	UIKitchenSinkNativeItemSwitch = -5,
	UIKitchenSinkNativeItemMultiButton = -6,
	UIKitchenSinkNativeItemSegmented = -7,
	
	UIKitchenSinkNativeItemTextView = -8,
	UIKitchenSinkNativeItemTextField = -9,
	UIKitchenSinkNativeItemSearchBar = -10,
	
	UIKitchenSinkNativeItemPicker = -11,
	UIKitchenSinkNativeItemDatePicker = -12,
	
	UIKitchenSinkNativeItemInfoLight = -13,
	UIKitchenSinkNativeItemInfoDark = -14,
	
	UIKitchenSinkNativeItemDisclosure = -15,
	
	UIKitchenSinkNativeItemContactAdd = -16
};
