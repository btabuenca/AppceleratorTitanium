...
//@interface StropheXmppClientObject : NSObject
//@end

@interface StropheXmppClientObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StropheXmppClientObject class]])
		{
			for (NSString *key in [[(StropheXmppClientObject*)o modules] allKeys])
			{
