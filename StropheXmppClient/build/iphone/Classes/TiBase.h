...
// in simulator we redefine to format for StropheXmppClient Developer console
...
{\
	NSString * exceptionName = [@"org.strophexmppclient." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.strophexmppclient";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIStropheXmppClientNativeItemNone = -1, 
	UIStropheXmppClientNativeItemSpinner = -2,
	UIStropheXmppClientNativeItemProgressBar = -3,
	
	UIStropheXmppClientNativeItemSlider = -4,
	UIStropheXmppClientNativeItemSwitch = -5,
	UIStropheXmppClientNativeItemMultiButton = -6,
	UIStropheXmppClientNativeItemSegmented = -7,
	
	UIStropheXmppClientNativeItemTextView = -8,
	UIStropheXmppClientNativeItemTextField = -9,
	UIStropheXmppClientNativeItemSearchBar = -10,
	
	UIStropheXmppClientNativeItemPicker = -11,
	UIStropheXmppClientNativeItemDatePicker = -12,
	
	UIStropheXmppClientNativeItemInfoLight = -13,
	UIStropheXmppClientNativeItemInfoDark = -14,
	
	UIStropheXmppClientNativeItemDisclosure = -15,
	
	UIStropheXmppClientNativeItemContactAdd = -16
};
