...
// in simulator we redefine to format for ouClicker Developer console
...
{\
	NSString * exceptionName = [@"org.ouclicker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ouclicker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIouClickerNativeItemNone = -1, 
	UIouClickerNativeItemSpinner = -2,
	UIouClickerNativeItemProgressBar = -3,
	
	UIouClickerNativeItemSlider = -4,
	UIouClickerNativeItemSwitch = -5,
	UIouClickerNativeItemMultiButton = -6,
	UIouClickerNativeItemSegmented = -7,
	
	UIouClickerNativeItemTextView = -8,
	UIouClickerNativeItemTextField = -9,
	UIouClickerNativeItemSearchBar = -10,
	
	UIouClickerNativeItemPicker = -11,
	UIouClickerNativeItemDatePicker = -12,
	
	UIouClickerNativeItemInfoLight = -13,
	UIouClickerNativeItemInfoDark = -14,
	
	UIouClickerNativeItemDisclosure = -15,
	
	UIouClickerNativeItemContactAdd = -16
};
