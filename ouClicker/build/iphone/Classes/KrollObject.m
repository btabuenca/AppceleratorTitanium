...
//@interface ouClickerObject : NSObject
//@end

@interface ouClickerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ouClickerObject class]])
		{
			for (NSString *key in [[(ouClickerObject*)o modules] allKeys])
			{
